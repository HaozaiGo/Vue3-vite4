...
Circle.prototype.draw = function(ctx) {
    ctx.beginPath();
    ctx.arc(this.x, this.y, this.radius, 0, Math.PI * 2, true); //坐标为250的圆，起始的角度是0，结束的角度Math.Pi*2
...
Ring.prototype.drawRing = function(ctx) {
    ...
    var handle = setInterval(function() {
        ...
        ctx.arc(that.x, that.y, that.radius, startAngle, endAngle, false); //这里的圆心坐标要和cirle的保持一致

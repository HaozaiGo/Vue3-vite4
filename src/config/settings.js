 ...
 * @LastEditTime: 2023-03-13 17:32:26
 * @FilePath: \vue-Mrbs-Service\src\config\settings.js
 */

let settings = {
    //前缀访问路径 //灵石wmmsservice
    urlBefore:'/mrbsservice',
    ...
    //烦请保留package.json作者信息 保留版权可免费商用 如需去除并自定义为自己企业的版权请联系xiaohao-13326745183
